...
using ENTech.Store.Database.CustomerModule.Configurations;
using ENTech.Store.Database.GeoModule;
using ENTech.Store.Database.GeoModule.Configurations;
using ENTech.Store.Database.OrderModule.Configurations;
using ENTech.Store.Database.PartnerModule;
using ENTech.Store.Database.PartnerModule.Configurations;
using ENTech.Store.Database.StoreModule;
using ENTech.Store.Database.StoreModule.Configurations;
