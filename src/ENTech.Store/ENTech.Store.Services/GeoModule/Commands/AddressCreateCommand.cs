...
{
	public class AddressCreateCommand : DbContextCommandBase<AddressCreateRequest, AddressCreateResponse>
	{
		public AddressCreateCommand(IDbContext dbContext, bool requiresTransaction) : base(dbContext, requiresTransaction)
		{
		}
